...
def learn(model, num_epochs, optimizer, train_loader, 
          val_loader, num_classes=21, save_path=None,
    ...
    for epoch in range(num_epochs):
        ...
        model.eval()
        for val_imgs, val_anotations in tqdm(val_loader,desc='now validation',
